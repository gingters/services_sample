    ...
    public class Startup
    {
        ...
        private IEnumerable<Client> GetClients()
        {
            ...
            yield return new Client()
            {
                ...
                ClientSecrets = new List<Secret>()
                {
                    new Secret("serviceclient".Sha256()), // Don't use in production, get it from e.g. environment
                },
                AllowedScopes = new List<string>()
                {
                    "pushapi",
        ...
        private List<TestUser> GetTestUsers()
        {
            return new List<TestUser>()
            {
                new TestUser()
                {
                    ...
                    {
                        new Claim(JwtClaimTypes.Email, "alice@email.de"),
                    },
                },
                new TestUser()
                {
                    ...
                    Claims = new List<Claim>()
                    {
                        new Claim(JwtClaimTypes.Email, "bob@email.de"),
                    },
                },
            };
        }
